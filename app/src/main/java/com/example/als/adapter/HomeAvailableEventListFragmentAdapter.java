...
public class HomeAvailableEventListFragmentAdapter extends RecyclerView.Adapter<HomeAvailableEventListFragmentAdapter.ViewHolder> {
    ...
    public HomeAvailableEventListFragmentAdapter(List<Event> homeEventList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.home_available_event_list_view_layout,parent,false);
        return new HomeAvailableEventListFragmentAdapter.ViewHolder(view);
    }
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                holder.homeEventListProfileIV.setImageResource(R.drawable.loading_image);
                                            }
                                        });
                            }
                            else{
